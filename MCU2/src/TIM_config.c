...
void TIM_Configuration(void)
{
    ...
    TIM_TimeBaseStructure.TIM_Period = 1;                      // 1(1.2): 약 0.001초
    TIM_TimeBaseStructure.TIM_Prescaler = 59999;                 // 0~59999 이므로 60000 (0xEA5F = 59999)
    ...
    TIM_TimeBaseStructure.TIM_Period = 12;                       // 40: 0.033초
    ...
    // PWM //   // PWM //   // PWM //   // PWM //
    // PWM //   // PWM //   // PWM //   // PWM //
    TIM_TimeBaseStructure_PWM.TIM_Period = 719;       //1Mhz 입력에서 주기 20000으로 나누면 50Hz가 된다.
    TIM_TimeBaseStructure_PWM.TIM_Prescaler = 99;       //Prescaler가 72이면 1MHz가 된다.
